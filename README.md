...
- **翻索引** —— 完整索引在 [`solutions/README.md`](./solutions/README.md)：按题号（题号可点击跳转题解）、按难度分组、按算法归类三个视图，都在这一页。
- **筛选 + 搜索** —— 打开 [`index.html`](./index.html)：本地双击即可，按难度和算法标签筛选，或输入题号 / 标题 / 标签实时过滤；题号与标题点开是本地题解，行尾的 `LeetCode ↗` 跳转在线题目页。
